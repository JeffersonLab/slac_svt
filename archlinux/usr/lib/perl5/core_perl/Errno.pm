...
"armv7l-linux-thread-multi-4.10.0-1-arch" or
	die "Errno architecture (armv7l-linux-thread-multi-4.10.0-1-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
